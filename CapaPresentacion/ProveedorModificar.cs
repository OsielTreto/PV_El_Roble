                    ...
                    else
                    {
                        ...
                        else
                        {
                            ...
                            else
                            {
                                ...
                                {
                                    if (MessageBox.Show("¿Desea continuar?", "Actualizar proveedor", MessageBoxButtons.YesNoCancel, MessageBoxIcon.Question) == DialogResult.Yes)
                                    {
                                        CNProveedores objProveedor = new CNProveedores();
                                        objProveedor.ModificarProveedor(lbId.Text, txtUser.Text, txtApePa.Text, txtApeMa.Text, txtDire.Text, txtTel.Text);
